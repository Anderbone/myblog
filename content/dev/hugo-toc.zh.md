...
上面的兩項，就是修改了layouts/_default/baseof.html，在末尾的body標簽前加一下脚本鏈接。
```html
...
<script src="https://cdn.rawgit.com/afeld/bootstrap-toc/v1.0.1/dist/bootstrap-toc.min.js"></script>
```
最上面的Link処，awesome-webfont下面加以下兩個link。
```html
...
```
4. Determine the layout. 用body把之前的section包住。修改layouts/posts/single.html. This is my example:
